      ...
      <!-- User interface -->
       ...
       <li class="menu-item  @if(Route::currentRouteName() == 'listing.student.filter') active @endif" style="">
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item">
            <a href="{{url('/staff/student-listing/fiterd/'.'2')}}" class="menu-link">
          ...
          <li class="menu-item">
            <a href="{{url('/staff/student-listing/fiterd/'.'4')}}" class="menu-link">
              <div data-i18n="Connections">4thth Class</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="{{url('/staff/student-listing/fiterd/'.'5')}}" class="menu-link">
              <div data-i18n="Connections">5th Class</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="{{url('/staff/student-listing/fiterd/'.'6')}}" class="menu-link">
              <div data-i18n="Connections">6th Class</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="{{url('/staff/student-listing/fiterd/'.'7')}}" class="menu-link">
              <div data-i18n="Connections">7th Class</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="{{url('/staff/student-listing/fiterd/'.'8')}}" class="menu-link">
              <div data-i18n="Connections">8th Class</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="{{url('/staff/student-listing/fiterd/'.'9')}}" class="menu-link">
              <div data-i18n="Connections">9th Class</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="{{url('/staff/student-listing/fiterd/'.'10')}}" class="menu-link">
              <div data-i18n="Connections">10th Class</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="{{url('/staff/student-listing/fiterd/'.'11')}}" class="menu-link">
              <div data-i18n="Connections">11th Class</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="{{url('/staff/student-listing/fiterd/'.'12')}}" class="menu-link">
