...
@section('content')
    <section class="bg-light">
        <div class="container">
            <div class="row pt-4">
                <div class="d-flex justify-content-center col-lg-6 order-2 order-lg-1 mb-2">
                ...
                <div class="d-flex justify-content-center col-lg-6 order-2 order-lg-1 mb-2">
                    <a href="{{route('login.staff')}}" class="btn btn-primary shadow mr-2">Staff Login</a>
                </div>
                <div class="d-flex justify-content-center col-lg-6 order-2 order-lg-1 mb-2">
                    <a href="{{route('listing')}}" class="btn btn-primary shadow mr-2">Listing</a>
                </div>
                <div class="d-flex justify-content-center col-lg-12 order-2 order-lg-1">
