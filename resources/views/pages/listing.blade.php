                ...
                <tbody>
                    @foreach($students as $student)
                        <tr>
                            ...
                            <td>
                                <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-success btn-sm viewStudent m-1" data-id="{{$student->id}}">View</button>
                                <a href="{{url('/edit-student/'.$student->id)}}" class="btn btn-info btn-sm m-1">Edit</a>
